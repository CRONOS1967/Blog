                    ...
                    <div class="row mt-2 alert-validation">
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="blog-edit-title" class="form-control" name="title" placeholder="title of blog" value="<?= $post['title']; ?>" />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div id="blog-editor-wrapper">
                                    <div id="blog-editor-container">
                                        <textarea name="body" id="" style="width: 100%;height:15rem ;"><?= $post['body']; ?></textarea>
                                    </div>
                                </div>
                            </div>
